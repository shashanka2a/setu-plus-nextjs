        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6">
              <span className="block animate-slide-in-left">Setu.plus –</span>
              <span className="block bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent animate-slide-in-right">
                The Everything App
              </span>
              <span className="block animate-slide-in-left">for Digital Commerce</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-600 mb-4 max-w-2xl lg:mx-0 mx-auto animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              Democratizing commerce through AI-powered open networks.
            </p>
            
            <p className="text-lg md:text-xl text-gray-500 mb-8 max-w-2xl lg:mx-0 mx-auto italic animate-fade-in-up" style={{animationDelay: '0.4s'}}>
