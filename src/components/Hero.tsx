      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          <div className="text-center lg:text-left animate-fade-in-up space-y-10">
            {/* Brand Badge */}
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-full px-4 py-2 text-sm font-medium text-blue-700 animate-slide-in-left opacity-100">
              <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
              Setu.plus Platform
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight space-y-2">
              <span className="block animate-slide-in-left text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-600 opacity-100">The</span>
              <span className="block bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent animate-slide-in-right opacity-100">
                Everything App
              </span>
